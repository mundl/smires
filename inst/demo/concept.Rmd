...
# Threshold 
A day is considered **dry** if the observed discharge is **smaller or equal** to the threshold discharge. Given a threshold of 0 m³/s and an observed discharge of 0 m³/s, this day is classified as dry. 

# Time intervals
```{r, message=FALSE, echo=FALSE}
head(find_events(balder, period = "year"), 2)
```
